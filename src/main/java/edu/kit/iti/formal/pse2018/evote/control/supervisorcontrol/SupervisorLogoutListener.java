...
public class SupervisorLogoutListener extends SupervisorEventListener {

    public SupervisorLogoutListener(SupervisorControlToViewIF gui, SupervisorControlToModelIF model) {
        super(gui, model);
    }
